...
public class AutoPaths {
    ...
    public static void generatePoses(Follower follow) {
        ...
        intake1EndPose = flipOverCenter(new Pose(18, 80.25, intakeAngle)); //6//x:16 y:82//x: 16 :78
        ...
        intake2EndPose = flipOverCenter(new Pose(11, 57.75, intakeAngle));//x:15 x:8 y:58//x: 9 y:61
        intake3StartPose = flipOverCenter(new Pose(56.25, 33.75, intakeAngle));//y:38//y: 32
        intake3EndPose = flipOverCenter(new Pose(11, 33.75, intakeAngle));//x:18 y:38//y: 32

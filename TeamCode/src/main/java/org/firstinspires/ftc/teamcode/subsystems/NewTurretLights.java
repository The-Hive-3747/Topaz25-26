...
public class NewTurretLights {
    ...
    PrismAnimations.Solid leftBall, rightBall, frontBall, flywheelReady, info;
    ...
    public void executeLights(){
        leftBall.setStartIndex(startIndexBall1Right);
        rightBall.setStartIndex(startIndexBall3Right);
        frontBall.setStartIndex(startIndexBall2Right);
        leftBall.setStopIndex(stopIndexBall1Right);
        rightBall.setStopIndex(stopIndexBall2Right);
        frontBall.setStopIndex(stopIndexBall3Right);
        //flywheelReady.setStartIndex(start);
        prism.insertAndUpdateAnimation(GoBildaPrismDriver.LayerHeight.LAYER_0, leftBall);
        prism.insertAndUpdateAnimation(GoBildaPrismDriver.LayerHeight.LAYER_1, rightBall);
        prism.insertAndUpdateAnimation(GoBildaPrismDriver.LayerHeight.LAYER_2, frontBall);
        prism.insertAndUpdateAnimation(GoBildaPrismDriver.LayerHeight.LAYER_3, flywheelReady);
        prism.insertAndUpdateAnimation(GoBildaPrismDriver.LayerHeight.LAYER_4, info);
